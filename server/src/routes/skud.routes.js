...
const paginationValidation = [
  ...
  query("counterpartyName").optional().isString().trim().notEmpty(),
  query("constructionSiteId").optional().isUUID(),
  query("constructionSiteName").optional().isString().trim().notEmpty(),
  ...
  query("enrich").optional().isIn(["base", "full"]),
